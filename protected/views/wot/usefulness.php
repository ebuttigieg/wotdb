...
$this->widget('ext.jqgrid.JQGrid',
	array('options'=>array(
		...
		'colModel'=>array(
			...
			array('name'=>'pp','index'=>'pp','width'=>100,'align'=>'right','sorttype'=>'number','firstsortorder'=>'desc'),
			array('name'=>'tops','index'=>'tops','width'=>100,'align'=>'right','sorttype'=>'number'),
		...
		//	array('name'=>'updated_at','index'=>'updated_at','width'=>110,'align'=>'right','sorttype'=>'date','firstsortorder'=>'desc','formatter'=>'date','formatoptions'=>array('srcformat'=>'Y-m-d H:i:s','newformat'=>'d.m.Y H:i')),
			array('name'=>'usefulness','index'=>'usefulness','width'=>80,'align'=>'right','sorttype'=>'number','firstsortorder'=>'desc'),
		),
		'rowNum'=>1000,
