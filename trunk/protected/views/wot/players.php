...
$this->widget('ext.jqgrid.JQGrid',
	array('options'=>array(
		...
		'colNames'=>array('Игрок', 'Начал играть', 'Боев', 'Проц. побед','Сред. опыт','Макс. опыт','Эффект.','WN6','Неакт. дней'),
		'colModel'=>array(
	...
	//		array('name'=>'created_at','index'=>'created_at','width'=>50,'align'=>'right','summaryType'=>'sum','sorttype'=>'number'),
			...
			array('name'=>'battles_count','index'=>'battles_count','width'=>80,'align'=>'right','sorttype'=>'number','firstsortorder'=>'desc'),
